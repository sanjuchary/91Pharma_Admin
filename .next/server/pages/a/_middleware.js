...
exports.checkCookies = exports.removeCookies = exports.setCookies = exports.getCookie = exports.getCookies = void 0;
var cookie_1 = __webpack_require__(81457);
...
var removeCookies = function (key, options) {
    return (0, exports.setCookies)(key, '', __assign(__assign({}, options), { maxAge: -1 }));
};
...
var ref, ref1;
module.exports = ((ref = __webpack_require__.g.process) === null || ref === void 0 ? void 0 : ref.env) && typeof ((ref1 = __webpack_require__.g.process) === null || ref1 === void 0 ? void 0 : ref1.env) === 'object' ? __webpack_require__.g.process : __webpack_require__(24550);
...
/* provided dependency */ var process = __webpack_require__(47091);
        ...
        var mod = __webpack_require__(37775)
        var handler = mod.middleware || mod.default;

        if (typeof handler !== 'function') {
          throw new Error('The Middleware "pages/a/_middleware" must export a `middleware` or a `default` function');
        }
...
var _acceptHeader = __webpack_require__(15681);
var _denormalizePagePath = __webpack_require__(16166);
var _detectDomainLocale = __webpack_require__(33264);
var _formatUrl = __webpack_require__(21688);
var _normalizeLocalePath = __webpack_require__(5445);
...
var querystring = _interopRequireWildcard(__webpack_require__(59346));
...
var _routeRegex = __webpack_require__(62335);
...
var _getMiddlewareRegex = __webpack_require__(78403);
var _routeMatcher = __webpack_require__(60798);
var _routeRegex = __webpack_require__(62335);
var _routingItems = __webpack_require__(26262);
var _sortedRoutes = __webpack_require__(17046);
var _isDynamic = __webpack_require__(25376); //# sourceMappingURL=index.js.map
...
var _utils = __webpack_require__(77159);
...
var _escapeRegexp = __webpack_require__(71808);
...
/* harmony export */ });
/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(48301);
/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(next_server__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var cookies_next__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(67306);
...
function middleware(req, ev) {
    let token = (0,cookies_next__WEBPACK_IMPORTED_MODULE_1__.getCookie)("token", {
        // @ts-ignore
        req
    });
    if (!token) {
        ...
        if (path != "/a/logout") {
            ...
            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.redirect(new URL(url, req.url));
        }
...
var _utils = __webpack_require__(3542);
...
var _constants = __webpack_require__(28551);
...
exports.V = adapter;
var _error = __webpack_require__(80928);
var _utils = __webpack_require__(85625);
var _fetchEvent = __webpack_require__(53125);
var _request = __webpack_require__(47953);
var _response = __webpack_require__(47057);
...
var _getLocaleMetadata = __webpack_require__(65028);
var _cookie = _interopRequireDefault(__webpack_require__(39802));
var _routerUtils = __webpack_require__(5731);
...
var _nextUrl = __webpack_require__(92961);
var _utils = __webpack_require__(23198);
var _utils1 = __webpack_require__(85625);
var _cookie = _interopRequireDefault(__webpack_require__(39802));
var _uaParserJs = _interopRequireDefault(__webpack_require__(52824));
function _interopRequireDefault(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
    };
...
module.exports = {
  NextRequest: (__webpack_require__(47953).NextRequest),
  NextResponse: (__webpack_require__(47057).NextResponse),
}
...
/******/ var __webpack_exports__ = (__webpack_exec__(58735));
/******/ (_ENTRIES = typeof _ENTRIES === "undefined" ? {} : _ENTRIES)["middleware_pages/a/_middleware"] = __webpack_exports__;
/******/ }
]);
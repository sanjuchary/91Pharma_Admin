...
const Index = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (item) => (
        <div>
          <Link href={`/a/designations/${item.id}`}>
  ...
  const handleDelete = async (id) => {
    await axios
      .delete(`${API_URL}/designations/delete/${id}`, {
        headers: {
  ...
  return (
    <div>
      ...
      >
        <BreadCrumb
          items={[
            ...
            { text: "Designations List", url: "/a/designations" },
          ]}
        />
        <div
      ...
      <Table
        columns={columns}
        url={`${process.env.NEXT_PUBLIC_PROD_API_URL}/designations/get-all`}
        buttons={buttons}
        title="Coupons"
      />
    </div>

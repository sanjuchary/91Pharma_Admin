...
const Index = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (item) => (
        <div>
          <Link href={`/a/deductions/${item.id}`}>
  ...
  const handleDelete = async (id) => {
    await axios
      .delete(`${API_URL}/deductions/delete/${id}`, {
        headers: {
  ...
  return (
    <div>
      ...
      >
        <BreadCrumb
          items={[
            ...
            { text: "Deductions List", url: "/a/Deductions" },
          ]}
        />
        <div
      ...
      <Table
        columns={columns}
        url={`${process.env.NEXT_PUBLIC_PROD_API_URL}/deductions/get-all`}
        buttons={buttons}
        title="Coupons"
      />
    </div>

...
const Index = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (item) => (
        <div>
          <Link href={`/a/allowances/${item.id}`}>
  ...
  const handleDelete = async (id) => {
    await axios
      .delete(`${API_URL}/allowances/delete/${id}`, {
        headers: {
  ...
  return (
    <div>
      ...
      >
        <BreadCrumb
          items={[
            ...
            { text: "Allowances List", url: "/a/allowances" },
          ]}
        />
        <div
      ...
      <Table
        columns={columns}
        url={`${process.env.NEXT_PUBLIC_PROD_API_URL}/allowances/get-all`}
        buttons={buttons}
        title="Coupons"
      />
    </div>

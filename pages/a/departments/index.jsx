...
const Index = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (item) => (
        <div>
          <Link href={`/a/departments/${item.id}`}>
  ...
  const handleDelete = async (id) => {
    await axios
      .delete(`${API_URL}/departments/delete/${id}`, {
        headers: {
  ...
  return (
    <div>
      ...
      >
        <BreadCrumb
          items={[
            ...
            { text: "Departments List", url: "/a/departments" },
          ]}
        />
        <div
      ...
      <Table
        columns={columns}
        url={`${process.env.NEXT_PUBLIC_PROD_API_URL}/departments/get-all`}
        buttons={buttons}
        title="Coupons"
      />
    </div>
